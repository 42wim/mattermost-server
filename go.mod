module github.com/42wim/mattermost-server

require (
	github.com/42wim/viper-mattermost v1.0.1-0.20181109222325-361b3a19bd48
	...
	github.com/throttled/throttled v2.2.1+incompatible
